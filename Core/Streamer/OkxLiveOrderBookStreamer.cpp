...
OkxLiveOrderBookStreamer::OkxLiveOrderBookStreamer(const std::string& instrument, size_t ring_capacity)
...
bool OkxLiveOrderBookStreamer::handle_raw_message(const std::string& raw_message) {
